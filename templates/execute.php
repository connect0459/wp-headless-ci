<?php
$h1_str = whc_translate('Execute CI/CD');
$desctiption_str = whc_translate('Click the button below to manually trigger the CI/CD workflow:');
$button_str = whc_translate('Execute CI/CD');
?>
<div class="wrap">
    <h1><?= $h1_str ?></h1>
